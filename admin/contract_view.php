...
A RESIDENTIAL APARTMENT<br/>CONTRACT No.<?php echo $row['ID']; ?></span></td>
  ...
  <tr>
    ...
    <td colspan="2">Name: <strong><?php echo $row['name']; ?> <?php echo $row['surname']; ?></strong></td>
    <td colspan="2">Personal identity number: <strong><?php echo $row['thaiID'] ?></strong></td>
  </tr>
  <tr>
    <td colspan="4">Phone number: <strong><?php echo $row['tel']; ?></strong></td>
  </tr>
  <tr>
    <td colspan="4">Address during the tenancy: <strong><?php echo $row['address']; ?></strong></td>
  </tr>
  ...
  <tr>
    <td height="26" colspan="4">Number of room in the Apartment: <strong>ROOM <?php echo $row['room']; ?></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Rent</td>
    <td colspan="4">Rent is payable at SEK <u><strong>&nbsp;<?php echo $CURRENCY; ?><?php echo $row['monthly_fee']; ?>&nbsp;</strong></u> per month.  </td>
  </tr>
  <tr>
    <td>Electricity</td>
    <td colspan="4">Electricity  Is included in the rent  Is not included in the rent<br />
    The tenant shall pay for his/her own electricity  through payment to the landlord at SEK <u><strong>&nbsp;<?php echo $CURRENCY; ?><?php echo $row['fee_e']; ?>&nbsp;</strong></u> per month.</td>
  </tr>
  <tr>
    <td>Water</td>
    <td colspan="4">Electricity  Is included in the rent  Is not included in the rent<br />
The tenant shall pay for his/her own electricity  through payment to the landlord at SEK <u><strong>&nbsp;<?php echo $CURRENCY; ?><?php echo $row['fee_w']; ?>&nbsp;</strong></u> per month.</td>
  </tr>
  <tr>
    <td bgcolor="#CCCCCC">&nbsp;</td>
  ...
  <tr>
	...
	<p align="center" class="no-print"><a class="button green" href="javascript:window.print()"><img src='../images/printer.gif'></a> <a class="button green" href="javascript:window.history.back()">Back</a></p>
