...
<body>
   ...
   <?php require_once "leftbar.php" ?>
    ...
    <div id="datetime" class="no-print">
        ...
        <table style="width:100%;" class="no-print">
            <tr>
            	<td style="padding-top:0px;"> <h1>Receipt</h1></td>
                <td style="padding-top:0px; text-align:right;"> <span class="highlight" style="font-size:24px; background-color:#4F8954;">&nbsp;PAID&nbsp;</span></td>
            </tr>
        </table>
         <?php
		 	$id = $_GET['ID'];
			mysql_select_db("webpro",$con);
			$result = mysql_query("SELECT *,i.ID as InvID FROM invoice as i, contract as c WHERE  i.ID = $id  AND i.contractID = c.ID AND i.status = '1'");
			if($result === FALSE) {
  ...
  <td style="padding:15px;">
          ...
          <tr>
            ...
            <td width="25%">&nbsp;</td>
            <td width="25%">&nbsp;</td>
            <td width="25%" rowspan="2"><h1 style="margin:0px;">RECEIPT</h1></td>
          </tr>
          <tr>
		...
		<p>This payment have been paid at <?php echo $row['paiddate']; ?>
        </p>
    </td>
  </tr>
  </table>       
